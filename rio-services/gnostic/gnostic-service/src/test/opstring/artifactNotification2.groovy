...
deployment(name: 'Notification Using Artifact Test Part Deaux') {
    ...
    artifact id: 'service', 'org.rioproject.gnostic.service:gnostic-service:5.0-M4-sorcer3'
    artifact id: 'service-api', 'org.rioproject.gnostic:gnostic-api:5.0-M4-sorcer3'
